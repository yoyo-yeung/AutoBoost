package kwyyeung.autoboost.program.analysis;
...
public class MethodDetails {
    ...
    private Set<Pair<String, String>> accessedCalleeFields = new HashSet<>();
    ...
    public Set<Pair<String, String>> getAccessedCalleeFields() {
        return accessedCalleeFields;
    }

    public void setAccessedCalleeFields(Set<Pair<String, String>> accessedCalleeFields) {
