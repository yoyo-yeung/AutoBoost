...
import kwyyeung.autoboost.program.execution.stmt.Stmt;
...
public abstract class TestCase {
    ...
    private final MethodExecution target;

    public TestCase(MethodExecution target) {
    ...
    public MethodExecution getTarget() {
        return target;
    }
